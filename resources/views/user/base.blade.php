                ...
                <ul class="nav">
                    ...
                    <li class="nav-item dropdown nav--user online">
                        <a href="#" class="nav-link" data-toggle="dropdown">
                            ...
                            <span>{{ Session::get('user_data')->nama_lengkap}}</span>
        ...
        <aside class="sidebar" data-trigger="scrollbar">
            ...
            <div class="sidebar--profile">
                ...
                <div class="profile--name">
                    <a href="profile.html" class="btn-link">{{ Session::get('user_data')->nama_lengkap}}</a>
                </div>
            ...
            <div class="sidebar--nav">
                <ul>
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="/user/dashboard"><i class="fa fa-address-book"></i> <span>Dashboard</span></a>
                                <a href="/user/pembayaran"><i class="fa fa-shopping-cart"></i> <span>Pembayaran Pendafataran</span></a>
                                <a href="/user/tiket"><i class="fa fa-th-list"></i> <span>Tiket</span></a>
                                <a href="/user/sertifikat"><i class="fa fa-qrcode"></i> <span>E-Sertifikat</span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
