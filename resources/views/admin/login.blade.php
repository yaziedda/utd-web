...
<head>
    ...
    <!-- ==== Document Title ==== -->
    <title>Login Admin - UTD 4 2019</title>
...
<body>
    ...
    <div class="wrapper">
        <!-- Register Page Start -->
        <div class="m-account-w" style="background: #AAA">
            <div class="m-account">
                <div class="row no-gutters flex-row-reverse">
                    ...
                    <div class="col-md-6">
                        <div class="row`">
                            <form action="/admin/login-user" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="col-md-12" style="margin-top: 16px;">
                                    ...
                                    <div class="m-account--form-w">
                                        <div class="m-account--form" style="padding: 0; margin: 0;">
                                            ...
                                            @endif
                                            <label class="m-account--title">LOGIN ADMIN UTD 4.0</label>
